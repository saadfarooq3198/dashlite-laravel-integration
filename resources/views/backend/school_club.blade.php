                ...
                <div class="row g-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="section_one_heading"
                                    value="{{settings('school_club', 'section_one_heading')}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="section_one_description" class="form-control summernote" data-feature="all">{!! settings('school_club', 'section_one_description') !!}
                                </textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="section_two_heading"
                                    value="{{settings('school_club', 'section_two_heading')}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="section_two_description" class="form-control summernote" data-feature="all">{!! settings('school_club', 'section_two_description') !!}
                                </textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" name="section_three_heading"
                                    value="{{settings('school_club', 'section_three_heading')}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="form-group">
                            <label class="form-label" for="customFileLabel">Upload Admission Image</label>
                            <div class="form-control-wrap">
                                <div class="custom-file">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="section_three_description" class="form-control summernote" data-feature="all">{!! settings('school_club', 'section_three_description') !!}
                                </textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">Save school_club</button>
                        </div>
                    </div>
                </div>
