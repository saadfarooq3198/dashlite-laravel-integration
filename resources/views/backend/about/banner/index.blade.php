                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    data-method="get"
                                                    data-action-url="{{ route('admin.about.banner.create') }}">
                                                        <em class="icon ni ni-plus"></em><span>Add Banner</span></a>
                                                </li>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner-group">
                                    <div class="card-inner p-0">
                                        <table class="datatable-init1 table" id="banner-table">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">

                                                    <th class="nk-tb-col py-2"><span class="sub-text">Sr No.</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">Page Name</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">Banner</span></th>
            ...
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#banner-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.about.banner.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
