                                        ...
                                        <div class="toggle-expand-content" data-content="pageMenu">
                                            <ul class="nk-block-tools g-3">
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    ...
                                                    data-method="get"
                                                    data-action-url="{{ route('admin.employees.create') }}">
                                                        <em class="icon ni ni-plus"></em><span>Add Employee</span></a>
                                                </li>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner-group">
                                    <div class="card-inner p-0">
                                        <table class="datatable-init1 table" id="employee-table">
                                            <thead>
                                                <tr class="nk-tb-item nk-tb-head">
                                                    <th class="nk-tb-col py-2"><span class="sub-text">Sr No.</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">Employee Name</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">designation</span></th>
                                                    <th class="nk-tb-col py-2"><span class="sub-text">description</span></th>
            ...
            $(document).ready(function() {
                ...
                $(function() {
                    var table = $('#employee-table').DataTable({
                        ajax: {
                            url: "{{ route('admin.about.employee.datatable') }}",
                        },
                        processing: false,
                        serverSide: true,
                        scrollX: false,
